...
const BrowseEvents: React.FC = () => {
    ...
    }, [locationFilter, whenFilter, inactiveFilter, eventTypeFilter, categoryFilter])
    ...
    const filteredEvents = useMemo(() => {
        ...
        return events.filter(event => event.cost_type.toLowerCase() === lookingForFilter)
    }, [events, lookingForFilter])
